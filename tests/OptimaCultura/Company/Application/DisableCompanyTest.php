...
final class DisableCompanyTest extends TestCase
{
    #[Test]
    public function disableACompany()
    {
        ...
        $service = new DisableCompany($repository);
        $disabledCompany = $service->handle($companyId);

        $this->assertInstanceOf(Company::class, $disabledCompany);
        $this->assertEquals('inactive', $disabledCompany->status()->name());
    }
}
